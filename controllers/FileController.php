...
namespace devortix\filemanager\controllers;

use devortix\filemanager\models\MediafileSearch;
use Yii;
...
class FileController extends Controller
{
    ...
    {
        $this->layout = '@vendor/devortix/yii2-filemanager/views/layouts/main';
